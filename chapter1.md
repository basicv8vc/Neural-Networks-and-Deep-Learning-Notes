...
数据集我们使用![MNIST](http://yann.lecun.com/exdb/mnist/)，里面含有很多手写数字图像以及对应的标签，这里指图像中的数字。MNIST分为两部分：60000张25*28的灰度图像是训练集，10000张28*28的灰度图像作为测试集。


我们使用$$(x,y)$$来表示一个训练样本，其中$$x$$是784维度的向量，$$y$$是10维度向量，$$y=y(x)$$。
